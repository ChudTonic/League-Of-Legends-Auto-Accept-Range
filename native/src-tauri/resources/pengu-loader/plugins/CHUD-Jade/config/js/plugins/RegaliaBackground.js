const baseData = [
    {
        groupName: "ChudBackground",
        titleKey: "el_ChudBackground",
        titleName: "Chud / Background",
        capitalTitleKey: "el_ChudBackground_capital", 
        capitalTitleName: "Chud / Background",
        element: [
            {
                name: "bgcm-settings", 
                title: "el_ChudBackground_settings",
                titleName: "SETTINGS",
                class: "bgcm-settings",
                id: "ChudBackgroundSettings",
            },
        ],
    },
];
...
(() => {
    ...
    class BGCM {
        ...
        createVideoBackground(url) {
            ...
            video.onerror = async () => {
                ...
                try {
                    ...
                    if (window.CHUDJadeLog) {
                        window.CHUDJadeLog('error', "[BGCM] Failed to fallback to image background", { error: error.message || error });
                    } else {
        ...
        async showModal() {
            ...
            const logoUrl = '/plugins/CHUD-Jade/assets/logo.png';
