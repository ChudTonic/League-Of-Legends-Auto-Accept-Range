...
(() => {
    ...
    class ChudAA {
        ...
        const savedSettings = await window.DataStore?.get("eaa-settings");
            if (savedSettings) {
                try {
                    ...
                    this.settings.ChudAA = parsed.ChudAA ?? true;
        ...
        checkForMatch() {
            ...
            if (dialogLargeElement && !this.styleElement && (this.settings.ChudAA || this.settings.hideModal)) {
                ...
                if (checkboxes[0]) {
                    ...
                    if (checkbox) {
                        checkbox.addEventListener('change', (e) => {
                            this.settings.ChudAA = e.target.checked;
                            this.saveSettings();
    ...
    const baseData = [
        {
            groupName: "ChudAA",
            titleKey: "el_ChudAA",
            titleName: "Chud / AutoAccept",
            capitalTitleKey: "el_ChudAA_capital", 
            capitalTitleName: "Chud / AutoAccept",
            element: [
                {
                name: "eaa-settings", 
                title: "el_ChudAA_settings",
                titleName: "SETTINGS",
                class: "eaa-settings",
                id: "ChudAASettings",
                },
